...
from ReyzuMusic.misc import SUDOERS, db
from ReyzuMusic.utils.database import (is_active_chat,
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await Reyzu.pause_stream(chat_id)
        ...
        await Reyzu.resume_stream(chat_id)
        await CallbackQuery.message.reply_text(
        ...
        await Reyzu.mute_stream(chat_id)
        await CallbackQuery.message.reply_text(
        ...
        await Reyzu.unmute_stream(chat_id)
        await CallbackQuery.message.reply_text(
