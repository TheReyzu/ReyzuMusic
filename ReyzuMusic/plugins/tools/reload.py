...
from ReyzuMusic.utils.database import get_authuser_names, get_cmode
from ReyzuMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from ReyzuMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Reyzu.stop_stream(message.chat.id)
    except:
        pass
